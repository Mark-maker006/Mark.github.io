      ...
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {metrics.map((metric) => (
            <div
              key={metric.label}
              className="rounded-2xl border border-neutral-border bg-neutral-surface p-4 dark:border-dark-neutral-border dark:bg-dark-neutral-surface"
            >
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          <section className="space-y-4 lg:col-span-8">
            {candidates.map((candidate) => (
              <article
                key={candidate.name}
                className="rounded-2xl border border-neutral-border bg-neutral-surface p-4 dark:border-dark-neutral-border dark:bg-dark-neutral-surface sm:p-5"
              >
